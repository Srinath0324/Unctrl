...
export default function Faqs() {
	return (
		<section id="faqs" className="relative min-h-[100svh] bg-white text-black overflow-hidden">
		...
		<div className="rounded-md overflow-hidden bg-[#FF5900] text-white shadow-[0_4px_0_0_rgba(0,0,0,0.25)]">
			<button
				...
				<span className="flex items-center gap-6">
					<span className="text-2xl sm:text-3xl font-extrabold tabular-nums w-10">{String(index).padStart(2, "0")}</span>
